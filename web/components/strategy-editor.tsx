...
const INDICATOR_PARAMS: Record<string, ParamSpec[]> = {
  ...
  ema:          [{ key: "period", label: "Period", inputType: "number", default: 20 }, { key: "column", label: "Column", inputType: "column", default: "close" }],
  sma:          [{ key: "period", label: "Period", inputType: "number", default: 20 }, { key: "column", label: "Column", inputType: "column", default: "close" }],
